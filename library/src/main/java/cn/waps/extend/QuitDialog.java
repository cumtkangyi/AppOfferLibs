...
public class QuitDialog {
	...
	private static QuitDialog quitPopAd;

	public static QuitDialog getInstance() {
		if (quitPopAd == null) {
			quitPopAd = new QuitDialog();
		}
		return quitPopAd;
	}
									...
									public void onClick(DialogInterface dialog,
										...
										try {
											Intent intent = new Intent(
													Intent.ACTION_VIEW);
											intent.setData(Uri
													.parse("http://kangvp.apps.cn/details?app=b60aeca8e22f271d6f18a2f2cf332726"));
	...
	private void showCustomDialog(final Context context, View view) {
		AlertDialog.Builder builder = new AlertDialog.Builder(context)
				...
				.setNeutralButton("美女刮刮", new AlertDialog.OnClickListener() {
					@Override
